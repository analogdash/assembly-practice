...
key2 db "let there be light"
	...
	writtenbytesascii db 32 DUP (0)
	readbytesascii db 32 DUP (0)
	
	
	leftside db 32 DUP (0)
	rightside db 32 DUP (0)
	divider db " - ", 0
...
fbox proc ;runs eax through the fbox while preserving ebx,ecx, and edx
push edx
push ebx
push ecx
...
blowfish_encrypt proc ;left is eax, right is ebx
...
blowfish_decrypt proc ;left is eax, right is ebx
